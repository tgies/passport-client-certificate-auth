 ...
 * @param {string} [options.chainHeader]
...
Strategy.prototype.authenticate = function authenticate(req) {
    ...
    if (!result.success) {
        ...
        switch (result.reason) {
            ...
            default:
                return this.fail('Client certificate authentication failed', 401);
        }
    }
